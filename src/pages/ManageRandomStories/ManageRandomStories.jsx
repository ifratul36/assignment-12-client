  ...
  useEffect(() => {
    const fetchStories = async () => {
      try {
        ...
        const shuffledStories = storiesData.sort(() => Math.random() - 0.5).slice(0, 4);
        const updatedStories = shuffledStories.map((story) => ({
          ...story,
          currentIndex: 0,
        }));
...
export default ManageRandomStories;
