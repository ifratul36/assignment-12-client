...
//           const response = await axios.get(`https://assignment-12-server-jet-six.vercel.app/users`);
...
//                 onChange={(e) =>
//                   setUpdatedData({ ...updatedData, photoURL: e.target.value })
//                 }
//                 className="border rounded px-4 py-2 w-full"
//               />
//             </div>
//             {/* Display Email and Role as Read-only */}
//             <div className="mb-4">
//               <label className="block text-sm">Email:</label>
//               <input
//                 type="text"
//                 value={userData.email} // Static value, can't be edited
//                 readOnly
...
//               <input
//                 type="text"
//                 value={userData.role || "No Role"} // Static value, can't be edited
//                 readOnly
//                 className="border rounded px-4 py-2 w-full bg-gray-100 cursor-not-allowed"
//               />
//             </div>
...
const ManageProfile = () => {
  ...
  const handleSave = async () => {
    try {
      console.log("Saving updated data:", updatedData);  // Log the data being sent
      // Send the updated data to the backend
      const response = await axiosSecure.patch(
        `/users/${userData._id}`,
        updatedData
